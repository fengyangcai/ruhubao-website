...
function(t) {
	...
	i.DEFAULTS = {
		...
		a || (a = "YDUI_" + o.host.toUpperCase().replace(/\/?\.?:?/g, "")), i.backParamsKey = a + "_BACKPARAMS", i.backParamsListKey =
			a + "_LIST_", i.$element.append(i.$tag = $('<div class="J_InfiniteScrollTag"></div>')), i.listOffsetTop = i.$element
			.offset().top, i.initLoadingTip(), n.initLoad && (n.backposition ? !e.sessionStorage.get(i.backParamsKey) && i.loadList() :
				i.loadList()), i.bindScrollEvent(), n.backposition && (i.loadListFromStorage(), i.bindLinkEvent())
		...
		var t = this;
		if (!t.options.jumpLink) return void console.error("[YDUI warn]: 需指定跳转详情页链接元素");
		$(t.options.binder).on("click.ydui.infinitescroll", t.options.jumpLink, function(i) {
			i.preventDefault();
			var n = $(this),
				o = n.data("page");
			if (!o) return void console.error('[YDUI warn]: 跳转链接元素需添加属性[data-page="其所在页码"]');
			e.sessionStorage.set(t.backParamsKey, {
		...
		t.loading = !0, t.$loading.show(), "function" == typeof i.loadListFn && i.loadListFn().done(function(n, o) {
			var a = n.length;
			if (~~a <= 0) return void console.error("[YDUI warn]: 需在 resolve() 方法里回传本次获取记录集合");
			a < i.pageSize && (t.$element.append('<div class="list-donetip">' + i.doneTxt + "</div>"), t.isDone = !0), t.$loading
				.hide(), t.loading = !1, i.backposition && e.sessionStorage.set(t.backParamsListKey + o, n)
		})
		...
		if (i) {
			...
			for (var n = i.page, o = [], a = 1; a <= n; a++) {
				...
				o.push({
					page: a,
					list: r
				}), a == n && r.length < t.options.pageSize && (t.$element.append('<div class="list-donetip">' + t.options.doneTxt +
					"</div>"), t.$loading.hide(), t.loading = !1, t.isDone = !0)
			}
...
function(t) {
	...
	e.DEFAULTS = {
		...
		var t = this,
			e = t.touches;
		t.$dragTip = $('<div class="pullrefresh-dragtip"><span></span></div>'), t.$element.after(t.$dragTip), t.offsetTop =
			t.$element.offset().top, t.initTip(), t.bindEvent(), t.options.initLoad && (e.loading = !0, "function" == typeof t.options
				.loadListFn && t.options.loadListFn().done(function() {
					e.loading = !1
				}))
		...
		e.$element.offset().top < e.offsetTop || (e.touches.startClientY = t.originalEvent.touches[0].clientY)
		...
		if (!(e.touches.startClientY > i.clientY || e.$element.offset().top < e.offsetTop || e.touches.loading)) {
			...
			e.$dragTip.find("span").css("opacity", n / 100), n >= e.options.distance && (n = e.options.distance), e.$dragTip.find(
				"span").css("transform", "rotate(" + n / .25 + "deg)"), e.touches.moveOffset = n, e.moveDragTip(n)
		}
		...
		if (!(e.$element.offset().top < e.offsetTop)) {
			if (e.$dragTip.addClass("pullrefresh-animation-timing"), i.moveOffset >= e.options.distance) return e.moveDragTip(e
				.options.distance / 1.5), e.$dragTip.find("span").addClass("pullrefresh-loading"), void e.triggerLoad();
			e.touches.isDraging = !1, e.resetDragTip(), e.resetLoading()
		}
	}, e.prototype.triggerLoad = function() {
		var t = this;
		t.touches.loading = !0, "function" == typeof t.options.loadListFn && t.options.loadListFn().done(function() {
			setTimeout(function() {
				t.$dragTip.css({
		...
		var t = this,
			e = t.touches;
		setTimeout(function() {
			e.isDraging = !1, e.loading = !1, e.moveOffset = 0, t.moveDragTip(0), t.resetLoading(), t.$dragTip.removeClass(
		...
		var e = this,
			i = t.localStorage;
		"YDUI" != i.getItem("LIST-PULLREFRESH-TIP") && (e.$tip = $(
			'<div class="pullrefresh-draghelp"><div><span>下拉更新</span></div></div>'), e.$tip.on("click.ydui.pullrefresh",
			function() {
				$(this).remove()
...
function(t) {
	...
	o.DEFAULTS = {
		...
		var i =
			'<div class="keyboard-head"><strong>输入数字密码</strong></div><div class="keyboard-error"></div><ul class="keyboard-password J_FillPwdBox">' +
			e() + "</ul>",
			n = '<div class="keyboard-content">   <div class="keyboard-title">' + t.options.title +
			'</div>   <ul class="keyboard-numbers"></ul></div>';
		t.$element.prepend(i).append(n), t.$numsBox = t.$element.find(".keyboard-numbers"), t.$mask = $(
			'<div class="mask-black"></div>')
	}, o.prototype.open = function() {
		var t = this,
			i = t.$element,
			n = t.$numsBox;
		YDUI.device.isIOS && $(".g-scrollview").addClass("g-fix-ios-overflow-scrolling-bug"), i.addClass(t.toggleClass), (t.options
				.disorder || 1 != n.data("loaded-nums")) && n.data("loaded-nums", 1).html(t.createNumsHtml()), e.append(t.$mask),
			t.bindEvent()
	}, o.prototype.close = function() {
		var t = this;
		YDUI.device.isIOS && $(".g-scrollview").removeClass("g-fix-ios-overflow-scrolling-bug"), t.$mask.remove(), t.$element
			.removeClass(t.toggleClass), t.unbindEvent(), t.inputNums = "", t.fillPassword(), t.clearError()
		...
		n.find("i").hide(), n.filter(":lt(" + i + ")").find("i").css("display", "block"), i >= 6 && t.$element.trigger($.Event(
			"done.ydui.keyboard", {
				password: e
			}))
		...
		return $.each(e, function(t) {
			t % 3 == 0 && (t >= e.length - 2 ? i.push('<li><a href="javascript:;" class="J_Cancel">取消</a>' + e.slice(t, t + 3)
				.join("") + '<a href="javascript:;" class="J_Backspace"></a></li>') : i.push("<li>" + e.slice(t, t + 3).join(
				"") + "</li>"))
		}), i.join("")
		...
		for (var o, a, r, e = Math.floor, i = Math.random, n = t.length, s = e(n / 2) + 1; s--;) o = e(i() * n), a = e(i() *
			n), o !== a && (r = t[o], t[o] = t[a], t[a] = r);
		return t
	}, $.fn.keyBoard = a
}(window),
function(t) {
	...
	i.DEFAULTS = {
		...
		var t = this,
			e = t.options;
		if ("undefined" == typeof YDUI_CITYS) return void console.error(
			"请在ydui.js前引入ydui.citys.js。下载地址：http://cityselect.ydui.org");
		t.citys = YDUI_CITYS, t.createDOM(), t.defaultSet = {
			provance: e.provance,
			city: e.city,
			area: e.area
		}
		...
		var i = t.$cityElement,
			n = t.defaultSet;
		i.find(".cityselect-content").removeClass("cityselect-move-animate cityselect-next cityselect-prev"), t.loadProvance(),
			n.provance ? t.setNavTxt(0, n.provance) : i.find(".cityselect-nav a").eq(0).addClass("crt").html("请选择"), n.city &&
			(t.loadCity(), t.setNavTxt(1, n.city)), n.area && (t.loadArea(), t.ForwardView(!1), t.setNavTxt(2, n.area)), i.addClass(
				"brouce-in")
	}, i.prototype.close = function() {
		var t = this;
		t.$mask.remove(), t.$cityElement.removeClass("brouce-in").find(".cityselect-nav a").removeClass("crt").html(""), t.$itemBox
			.html("")
	}, i.prototype.createDOM = function() {
		var t = this;
		t.$mask = $('<div class="mask-black"></div>'), t.$cityElement = $(
			'<div class="m-cityselect">    <div class="cityselect-header">        <p class="cityselect-title">所在地区</p>        <div class="cityselect-nav">            <a href="javascript:;" ></a>            <a href="javascript:;"></a>            <a href="javascript:;"></a>        </div>    </div>    <ul class="cityselect-content">        <li class="cityselect-item">            <div class="cityselect-item-box"></div>        </li>        <li class="cityselect-item">            <div class="cityselect-item-box"></div>        </li>        <li class="cityselect-item">            <div class="cityselect-item-box"></div>        </li>    </ul></div>'
		), e.append(t.$cityElement), t.$itemBox = t.$cityElement.find(".cityselect-item-box"), t.$cityElement.on(
			"click.ydui.cityselect", ".cityselect-nav a",
			function() {
				var e = $(this);
		...
		t < 2 && i.removeClass("crt"), i.eq(t).html(e), i.eq(t + 1).addClass("crt").html("请选择"), i.eq(t + 2).removeClass(
			"crt").html("")
	}, i.prototype.backOffView = function() {
		this.$cityElement.find(".cityselect-content").removeClass("cityselect-next").addClass(
			"cityselect-move-animate cityselect-prev")
	}, i.prototype.ForwardView = function(t) {
		this.$cityElement.find(".cityselect-content").removeClass("cityselect-move-animate cityselect-prev").addClass((t ?
			"cityselect-move-animate" : "") + " cityselect-next")
		...
		e.on("click.ydui.cityselect", ".cityselect-item-box a", function() {
			...
			if (!i.hasClass("crt")) {
				...
				var o = e.find(".cityselect-nav a"),
					a = t.defaultSet;
				0 == n ? (t.loadCity(), e.find(".cityselect-item-box").eq(1).find("a").removeClass("crt")) : 1 == n ? (t.loadArea(),
					t.ForwardView(!0), e.find(".cityselect-item-box").eq(2).find("a").removeClass("crt")) : (a.provance = o.eq(0).html(),
					a.city = o.eq(1).html(), a.area = o.eq(2).html(), t.returnValue())
			}
		})
		...
		$.each(t.citys, function(i, n) {
			e.push($('<a class="' + (n.n == t.defaultSet.provance ? "crt" : "") + '" href="javascript:;"><span>' + n.n +
				"</span></a>").data({
				citys: n.c,
				tag: 0
			}))
		...
		var t = this,
			...
			i = [];
		$.each(e, function(e, n) {
			i.push($('<a class="' + (n.n == t.defaultSet.city ? "crt" : "") + '" href="javascript:;"><span>' + n.n +
				"</span></a>").data({
				citys: n.a,
				tag: 1
			}))
		...
		var t = this,
			...
			i = [];
		$.each(e, function(e, n) {
			i.push($('<a class="' + (n == t.defaultSet.area ? "crt" : "") + '" href="javascript:;"><span>' + n +
				"</span></a>").data({
				tag: 2
			}))
...
function(t) {
	...
	e.DEFAULTS = {
		...
		var t = this,
			e = t.options;
		t.$input = $(e.input, t.$element), t.$add = $(e.add, t.$element), t.$minus = $(e.minus, t.$element), t.changeParameters(),
			t.checkParameters(), t.bindEvent()
		...
		$.each(i, function(i, n) {
			...
			if (a) o = a, t.isNumber(a) || "function" == typeof(o = e[n.param]) && (o = o());
		...
		var t = this,
			e = t.options,
			i = t.$input.val();
		i ? t.setValue(i) : (e.max < e.min && 0 != e.max && (e.max = e.min), e.min < e.unit && e.min > 0 && (e.min = e.unit),
			e.min % e.unit != 0 && e.min > 0 && (e.min = e.min - e.min % e.unit), e.max < e.unit && 0 != e.max && (e.max = e.unit),
			e.max % e.unit != 0 && (e.max = e.max - e.max % e.unit), e.min < 0 && (e.min = e.unit), t.setValue(e.min))
		...
		var e = this,
			...
			o = i.unit,
			a = i.min < 0 ? o : i.min;
		/^(([1-9]\d*)|0)$/.test(t) || (t = n), t > n && 0 != n && (t = n), t % o > 0 && (t = t - t % o + o) > n && 0 != n &&
			(t -= o), t < a && (t = a - a % o), e.$input.val(t), "function" == typeof i.callback && i.callback(t, e.$input)
	}, e.prototype.bindEvent = function() {
		var t = this,
			e = t.options,
		...
		i && (n = "touchstart.ydui.spinner", o = "touchend.ydui.spinner"), t.$add.on(n, function(i) {
			e.longpress && (i.preventDefault(), i.stopPropagation(), t.tapStartTime = (new Date).getTime() / 1e3, t.$add.on(o,
				function() {
					t.clearTapTimer()
				})), t.calculation("add")
		}), t.$minus.on(n, function(i) {
			e.longpress && (i.preventDefault(), i.stopPropagation(), t.tapStartTime = (new Date).getTime() / 1e3, t.$minus.on(
				o,
				function() {
					t.clearTapTimer()
				})), t.calculation("minus")
...
function(t) {
	...
	function i(t) {
		return this.each(function() {
			var i = $(this);
			i.data("ydui.slider") || i.data("ydui.slider", new e(this, t))
		})
	}
	e.DEFAULTS = {
		speed: 300,
		...
		var t = this,
			e = t.options,
			i = t.$element;
		t.index = 1, t.autoPlayTimer = null, t.$pagination = i.find(e.pagination), t.$wrapper = i.find("." + e.wrapperClass),
			t.itemNums = t.$wrapper.find("." + e.slideClass).length, e.lazyLoad && t.loadImage(0), t.createBullet(), t.cloneItem()
			.bindEvent()
	}, e.prototype.bindEvent = function() {
		var e = this,
			i = e.touchEvents();
		...
		t.autoPlayTimer = setInterval(function() {
			t.index > t.itemNums && (t.index = 1, t.setTranslate(0, -t.$wrapper.width())), t.setTranslate(t.options.speed, -
				++t.index * t.$wrapper.width())
		}, t.options.autoplay)
		...
		var e = this,
			i = e.touches;
		if (i.allowClick = !0, i.isTouchEvent = "touchstart" === t.type, (i.isTouchEvent || !("which" in t) || 3 !== t.which) &&
			0 == i.moveTag) {
		...
		if (i.allowClick = !1, !i.isTouchEvent || "mousemove" !== t.type) {
			...
			0 != n && 0 != i.moveTag && (1 == i.moveTag && (e.stopAutoplay(), i.moveTag = 2), 2 == i.moveTag && e.setTranslate(
				0, -e.index * e.$wrapper.width() + n))
		}
		...
		if (setTimeout(function() {
			...
			n.moveTag = 0;
			Date.now() - n.touchStartTime > 300 && Math.abs(o) <= .5 * t.$wrapper.width() ? t.setTranslate(e, -t.index * t.$wrapper
				.width()) : t.setTranslate(e, -(o > 0 ? --t.index : ++t.index) * i), t.autoPlay()
		}
...
function(t, e) {
	...
	i.confirm = function(t, i, o) {
		...
		if ("function" != typeof arguments[1] && 2 == r && !arguments[1] instanceof Array) return void console.error(
			"From YDUI's confirm: The second parameter must be a function or array!!!");
		2 == r && (o = i, i = t, t = "提示");
		var s = o;
		"function" == typeof o && (s = [{
			txt: "取消",
		...
		var c = $('<div class="mask-black-dialog" id="' + a +
				'">   <div class="m-confirm">       <div class="confirm-hd"><strong class="confirm-title">' + t +
				'</strong></div>       <div class="confirm-bd">' + i + "</div>   </div></div>"),
			l = $('<div class="confirm-ft"></div>');
		$.each(s, function(t, i) {
			var n;
			"boolean" == typeof i.color ? n = $('<a href="javascript:;" class="confirm-btn ' + (i.color ? "primary" :
					"default") + '">' + (i.txt || "") + "</a>") : "string" == typeof i.color && (n = $(
					'<a href="javascript:;" style="color: ' + i.color + '">' + (i.txt || "") + "</a>")),
				function(t) {
		...
		$("#" + o).remove();
		var a = $('<div id="' + o +
			'">   <div class="mask-black-dialog">       <div class="m-confirm m-alert">           <div class="confirm-bd">' +
			(t || "YDUI Touch") +
			'</div>           <div class="confirm-ft">               <a href="javascript:;" class="confirm-btn primary">确定</a>           </div>       </div>   </div></div>'
		);
		...
		return function(i, o, a, r) {
			clearTimeout(t);
			var s = "YDUI_TOAST";
			if ($("#" + s).remove(), arguments.length < 2) return void console.error(
				"From YDUI's toast: Please set two or more parameters!!!");
			var l = "";
			"success" != o && "error" != o || (l = '<div class="' + ("error" == o ? "toast-error-ico" : "toast-success-ico") +
				'"></div>');
			var u = $('<div class="mask-white-dialog" id="' + s + '">    <div class="m-toast ' + ("" == l ? "none-icon" : "") +
				'">' + l + '        <p class="toast-content">' + (i || "") + "</p>    </div></div>");
			e.util.pageScroll.lock(), n.append(u), "function" == typeof a && arguments.length >= 3 && (r = a, a = 2e3), t =
				setTimeout(function() {
		...
		return function(e, i, o) {
			...
			var s = function() {
				...
				c = function() {
					clearTimeout(t), r.find(".m-notify").addClass("notify-out"), r.one("webkitTransitionEnd", s).emulateTransitionEnd(
						150)
				};
		...
		return {
			open: function(i) {
				$("#" + t).remove();
				var o = $('<div class="mask-white-dialog" id="' + t +
					'">   <div class="m-loading">       <div class="loading-icon"></div>       <div class="loading-txt">' + (i ||
						"数据加载中") + "</div>   </div></div>").remove();
...
function(t) {
	...
	function n(t, e) {
		this.pathTemplate =
			"M 50,50 m 0,-{radius} a {radius},{radius} 0 1 1 0,{2radius} a {radius},{radius} 0 1 1 0,-{2radius}", a.apply(this,
				arguments)
	}
	...
	function r(t) {
		...
		return this.each(function() {
			...
			a || ("line" == t.type ? i.data("ydui.progressbar", a = new o(this, t)) : i.data("ydui.progressbar", a = new n(
				this, t)), t && "object" != typeof t || a.appendView()), "string" == typeof t && a[t] && a[t].apply(a, e)
		})
	}
	var e = t.document,
		i = t.YDUI.util;
	n.prototype = new a, n.prototype.getPathString = function(t) {
		...
		t.setAttribute("viewBox", "0 0 100 " + e.strokeWidth), t.setAttribute("preserveAspectRatio", "none"), t.style.width =
			"100%", t.style.height = "100%"
	}, a.DEFAULTS = {
		type: "circle",
		strokeWidth: 0,
		strokeColor: "#E5E5E5",
		...
		n.appendChild(o);
		var a = null;
		return (i.trailColor || i.trailWidth) && (a = t.createTrailPath(i), a.style.strokeDashoffset = a.getTotalLength(), n
			.appendChild(a)), t.svg = n, t.trailPath = a, {
			svg: n,
			trailPath: a
		}
		...
		return a.setAttribute("d", t), a.setAttribute("stroke", i), a.setAttribute("stroke-width", n), o ? a.setAttribute(
			"fill", o) : a.setAttribute("fill-opacity", "0"), a
...
function(t) {
	...
	function r(t) {
		...
		return this.each(function() {
			...
			n || (i.data("ydui.actionsheet", n = new a(this, t.closeElement)), t && "object" != typeof t || n.open()),
				"string" == typeof t && n[t] && n[t].apply(n, e)
		})
	}
	var e = t.document,
		i = $(e),
	...
	a.prototype.open = function() {
		...
		var t = this;
		YDUI.device.isIOS && $(".g-scrollview").removeClass("g-fix-ios-overflow-scrolling-bug"), o.off(
			"click.ydui.actionsheet.mask").remove(), t.$element.removeClass(t.toggleClass).trigger("close.ydui.actionsheet")
...
function(window) {
	...
	util.timestampTotime = function(t, e) {
		var i = {},
			n = Math.floor;
		i.f = e % 1e3, e = n(e / 1e3), i.s = e % 60, e = n(e / 60), i.m = e % 60, e = n(e / 60), i.h = e % 24, i.d = n(e /
			24);
		var o = function(t) {
			return t <= 0 ? "" : "$1" + (t < 10 ? "0" + t : t) + "$2"
		};
		return t = t.replace(/\{([^{]*?)%d(.*?)\}/g, o(i.d)), t = t.replace(/\{([^{]*?)%h(.*?)\}/g, o(i.h)), t = t.replace(
			/\{([^{]*?)%m(.*?)\}/g, o(i.m)), t = t.replace(/\{([^{]*?)%s(.*?)\}/g, o(i.s)), t = t.replace(
			/\{([^{]*?)%f(.*?)\}/g, o(i.f))
		...
		switch (m = Math.pow(10, Math.max(ra, rb)), op) {
			...
			case "-":
				...
				break;
			case "*":
				ra = Math.pow(10, ra), rb = Math.pow(10, rb), m = ra * rb, arg1 = Math.round(arg1 * ra), arg2 = Math.round(arg2 *
					rb);
				break;
			case "/":
		...
		return {
			...
			set: function(t, e, i, n, o, a) {
				var r = String(encodeURIComponent(e)),
					s = i;
				"number" == typeof s && (s = new Date, s.setTime(s.getTime() + 1e3 * i)), s instanceof Date && (r += "; expires=" +
						s.toUTCString()), !!n && (r += "; domain=" + n), r += "; path=" + (o || "/"), a && (r += "; secure"), doc.cookie =
					t + "=" + r
			}
		}
	}()
...
function(t) {
	...
	function e(t, i) {
		this.$element = $(t), this.options = $.extend({}, e.DEFAULTS, i || {}), this.init(), this.bindEvent(), this.transitioning = !
			1
	}
...
function() {
	...
	function t(e, n) {
		...
		var o;
		if (n = n || {}, this.trackingClick = !1, this.trackingClickStart = 0, this.targetElement = null, this.touchStartX =
			0, this.touchStartY = 0, this.lastTouchIdentifier = 0, this.touchBoundary = n.touchBoundary || 10, this.layer = e,
			this.tapDelay = n.tapDelay || 200, this.tapTimeout = n.tapTimeout || 700, !t.notNeeded(e)) {
			for (var r = ["onMouse", "onClick", "onTouchStart", "onTouchMove", "onTouchEnd", "onTouchCancel"], s = this, c = 0,
					l = r.length; c < l; c++) s[r[c]] = a(s[r[c]], s);
			i && (e.addEventListener("mouseover", this.onMouse, !0), e.addEventListener("mousedown", this.onMouse, !0), e.addEventListener(
					"mouseup", this.onMouse, !0)), e.addEventListener("click", this.onClick, !0), e.addEventListener("touchstart",
					this.onTouchStart, !1), e.addEventListener("touchmove", this.onTouchMove, !1), e.addEventListener("touchend", this
					.onTouchEnd, !1), e.addEventListener("touchcancel", this.onTouchCancel, !1), Event.prototype.stopImmediatePropagation ||
	...
	t.prototype.needsClick = function(t) {
			...
			var i, n;
			document.activeElement && document.activeElement !== t && document.activeElement.blur(), n = e.changedTouches[0], i =
				document.createEvent("MouseEvents"), i.initMouseEvent(this.determineEventType(t), !0, !0, window, 1, n.screenX, n.screenY,
					n.clientX, n.clientY, !1, !1, !1, !1, 0, null), i.forwardedTouchEvent = !0, t.dispatchEvent(i)
			...
			return this.trackingClick = !0, this.trackingClickStart = t.timeStamp, this.targetElement = e, this.touchStartX = i.pageX,
				this.touchStartY = i.pageY, t.timeStamp - this.lastClickTime < this.tapDelay && t.preventDefault(), !0
			...
			return !this.trackingClick || ((this.targetElement !== this.getTargetElementFromEventTarget(t.target) || this.touchHasMoved(
				t)) && (this.trackingClick = !1, this.targetElement = null), !0)
			...
			if (this.cancelNextClick = !1, this.lastClickTime = t.timeStamp, r = this.trackingClickStart, this.trackingClick = !
				1, this.trackingClickStart = 0, a && (l = t.changedTouches[0], u = document.elementFromPoint(l.pageX - window.pageXOffset,
					l.pageY - window.pageYOffset) || u, u.fastClickScrollParent = this.targetElement.fastClickScrollParent), "label" ===
				(s = u.tagName.toLowerCase())) {
				if (e = this.findControl(u)) {
					if (this.focus(u), i) return !1;
					u = e
				}
			} else if (this.needsFocus(u)) return t.timeStamp - r > 100 || n && window.top !== window && "input" === s ? (this.targetElement =
				null, !1) : (this.focus(u), this.sendClick(u, t), n && "select" === s || (this.targetElement = null, t.preventDefault()),
				!1);
			return !(!n || o || !(c = u.fastClickScrollParent) || c.fastClickLastScrollTop === c.scrollTop) || (this.needsClick(
				u) || (t.preventDefault(), this.sendClick(u, t)), !1)
			...
			var t = this.layer;
			i && (t.removeEventListener("mouseover", this.onMouse, !0), t.removeEventListener("mousedown", this.onMouse, !0), t.removeEventListener(
				"mouseup", this.onMouse, !0)), t.removeEventListener("click", this.onClick, !0), t.removeEventListener(
			...
			if (r && (o = navigator.userAgent.match(/Version\/([0-9]*)\.([0-9]*)/), o[1] >= 10 && o[2] >= 3 && (e = document.querySelector(
					"meta[name=viewport]")))) {
				if (-1 !== e.content.indexOf("user-scalable=no")) return !0;
				if (document.documentElement.scrollWidth <= window.outerWidth) return !0
			}
			return "none" === t.style.msTouchAction || "manipulation" === t.style.touchAction || (!!(+(/Firefox\/([0-9]+)/.exec(
				navigator.userAgent) || [, 0])[1] >= 27 && (e = document.querySelector("meta[name=viewport]")) && (-1 !== e.content
				.indexOf("user-scalable=no") || document.documentElement.scrollWidth <= window.outerWidth)) || ("none" === t.style
				.touchAction || "manipulation" === t.style.touchAction))
...
function(t) {
	...
	e.DEFAULTS = {
		...
		var t = this,
			e = t.$element,
			i = t.options;
		t.$navItem = e.find(i.navItem), t.$content = e.find(i.content), t.$contentItem = e.find(i.contentItem), t.scrolling = !
			1, t.contentOffsetTop = t.$content.offset().top, t.bindEvent(), t.movePosition(t.options.initIndex, !1)
	}, e.prototype.bindEvent = function() {
		var t = this;
		...
		var t = this;
		if (!t.scrolling) return t.isScrollTop() ? void t.setClass(0) : t.isScrollBottom() ? void t.setClass(t.$navItem.length -
			1) : void t.$contentItem.each(function() {
			var e = $(this);
...
function() {
	...
	function e(e) {
		...
		return this.each(function() {
			...
			o || (n.data("ydui.sendcode", o = new t(this, e)), "object" == typeof e && e.run && o.start()), "string" == typeof e &&
				o[e] && o[e].apply(o, i)
		})
	}
	t.DEFAULTS = {
